...
const (
	...
	OP_GET_GLOBAL
	OP_SET_GLOBAL
	OP_DEFINE_CLOSURE_VARIABLE
	OP_SET_CLOSURE_VARIABLE
	OP_GET_CLOSURE_VARIABLE
	OP_CALL
	OP_RETURN
	OP_END_OF_FN
	OP_TEMPLATE_LITERAL
...
var OpcodeNames = map[uint8]string{
	...
	OP_DEFINE_CLOSURE_VARIABLE:  "OP_DEFINE_CLOSURE_VARIABLE",
	OP_GET_CLOSURE_VARIABLE:     "OP_GET_CLOSURE_VARIABLE",
	OP_SET_CLOSURE_VARIABLE:     "OP_SET_CLOSURE_VARIABLE",
	OP_CALL:                     "OP_CALL",
	OP_RETURN:                   "OP_RETURN",
